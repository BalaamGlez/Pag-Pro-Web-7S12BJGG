...
<!-- INICIA LA COLUMNA -->
  ...
  <div class="col-md-4">
    ...
    <center><h1 style="color: #FFFFFF">REGISTRO DE DUDAS</h1></center>

    <form method="POST" action="Registro_dudas_oficial.php" enctype="multipart/form-data" >
    ...
    <div class="form-group">
        <label for="dir" style="color: #FFFFFF">DUDA</label>
        <input type="text" name="DUDA" class="form-control" id="DUDA" placeholder="DUDA">
    </div>
